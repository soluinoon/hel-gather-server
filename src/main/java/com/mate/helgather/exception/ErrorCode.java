...
public enum ErrorCode {
    ...
    NO_AUTHORIZATION_IN_HEADER(3011, "헤더에 JWT가 없습니다."),
    INVALID_JWT_TOKEN(3012, "잘못된 JWT 토큰입니다."),
    EXPIRED_JWT_TOKEN(3013, "만료된 JWT 토큰입니다."),
    UNSUPPORTED_JWT_TOKEN(3013, "지원하지 않는 JWT 토큰입니다."),
    CLAIM_STRING_EMPTY(3014, "JWT 클레임이 비었습니다."),
