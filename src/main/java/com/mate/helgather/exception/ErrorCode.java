...
public enum ErrorCode {
    ...
    NO_AUTHORIZATION_IN_HEADER(3012, "헤더에 JWT가 없습니다."),
    INVALID_JWT_TOKEN(3013, "잘못된 JWT 토큰입니다."),
    EXPIRED_JWT_TOKEN(3014, "만료된 JWT 토큰입니다."),
    UNSUPPORTED_JWT_TOKEN(3015, "지원하지 않는 JWT 토큰입니다."),
    CLAIM_STRING_EMPTY(3016, "JWT 클레임이 비었습니다."),
    NO_SUCH_MEMBER_ERROR(4001, "존재하지 않는 멤버입니다."),
    NO_SUCH_CHATROOM_ERROR(4002, "존재하지 않는 채팅방입니다."),
    ...
    NO_SUCH_SUB_LOCATION_ERROR(4011, "존재하지 않는 지역 입니다."),
    NO_SUCH_LOCATION_ERROR(4012, "존재하지 않는 상세 지역 입니다."),
    NO_SUCH_RECRUITMENT_ERROR(4013, "존재하지 않는 게시물 입니다."),
